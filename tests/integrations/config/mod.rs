...
fn test_serde_custom_tikv_config() {
    ...
    value.readpool = ReadPoolConfig {
        storage: StorageReadPoolConfig {
            high_concurrency: 1,
            high_active_concurrency: 1,
            high_max_wait_time: ReadableDuration::millis(10),
            normal_concurrency: 3,
            normal_active_concurrency: 2,
            normal_max_wait_time: ReadableDuration::millis(9),
            low_concurrency: 7,
            low_active_concurrency: 3,
            low_max_wait_time: ReadableDuration::millis(8),
