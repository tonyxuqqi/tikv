...
fn must_transfer_leader(cluster: &Cluster, from_off: usize, to_off: usize, to_peer: metapb::Peer) {
...
fn test_transfer_leader() {
    ...
    must_transfer_leader(&cluster, 0, 1, peer1);
    ...
    must_transfer_leader(&cluster, 1, 0, new_peer(store_id, peer0_id));
}
